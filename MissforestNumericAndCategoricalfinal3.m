...
errorbar(1:1:8,str2double(string(NRSME)),str2double(string(sd_NRSME)),'-k','MarkerSize',7,...
    'Marker','*','MarkerEdgeColor','black','MarkerFaceColor','black','LineWidth',1)
xlim([1 8])
xticks([1 2 3 4 5 6 7 8])
xticklabels({'10%','20%','30%','40%','50%','60%','70%','80%'})
title({'MissForest imputer method on numerical and categorical data';'24 Rows, 24 Columns';'15 Numeric features, 9 Text features'})
xlabel('Percentage of missing data')
ylabel('NRSME')
saveas(gcf,'fig3_NRSME.png')
hold off
%%
% Error plot for categorical data
errorbar(1:1:8,str2double(string(PFC)),str2double(string(sd_PFC)),'-k','MarkerSize',7,...
    'Marker','*','MarkerEdgeColor','black','MarkerFaceColor','black','LineWidth',1)
xlim([1 8])
xticks([1 2 3 4 5 6 7 8])
xticklabels({'10%','20%','30%','40%','50%','60%','70%','80%'})
