...
X_original = removevars(X_original,index_notnumeric);
%%
% n = 2*q
ratio = [8 2 1 0.5];
ind = 2;
...
title({'MissForest imputer method on numerical data';'30 Rows, 15 Columns';'15 Numeric features'})
xlabel('Percentage of missing data')
ylabel('NRSME')
saveas(gcf,'fig2cont_NRSME.png')