...
title({'MissForest imputer method on numerical and categorical data';'48 Rows, 24 Columns';'15 Numeric features, 9 Text features'})
xlabel('Percentage of missing data')
ylabel('NRSME')
saveas(gcf,'fig2_NRSME.png')
hold off
%%
