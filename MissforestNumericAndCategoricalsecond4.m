...
errorbar(1:1:4,str2double(string(PFC)),str2double(string(sd_PFC)),'-k','MarkerSize',7,...
    'Marker','*','MarkerEdgeColor','black','MarkerFaceColor','black','LineWidth',1)
xlim([1 4])
xticks([1 2 3 4])
xticklabels({'10%','20%','30%','40%'})
title({'MissForest imputer method on categorical data';'4 Rows, 9 Columns';'9 Text features'})
xlabel('Percentage of missing data')
ylabel('PEC')
saveas(gcf,'fig4cat_PFC.png')