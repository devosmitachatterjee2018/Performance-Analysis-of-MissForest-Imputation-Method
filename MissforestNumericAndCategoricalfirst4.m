...
errorbar(1:1:5,str2double(string(NRSME)),str2double(string(sd_NRSME)),'-k','MarkerSize',7,...
    'Marker','*','MarkerEdgeColor','black','MarkerFaceColor','black','LineWidth',1)
xlim([1 5])
xticks([1 2 3 4 5])
xticklabels({'10%','20%','30%','40%','50%'})
title({'MissForest imputer method on numerical data';'7 Rows, 15 Columns';'15 Numeric features'})
xlabel('Percentage of missing data')
ylabel('NRSME')
saveas(gcf,'fig4cont_NRSME.png')